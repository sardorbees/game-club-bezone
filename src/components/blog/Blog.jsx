            ...
            <div class="breadcumb-wrapper" data-bg-src="assets/img/bg/breadcumb-bg.jpg">
                <div class="container">
                    <div class="breadcumb-content">
                        <h1 class="breadcumb-title">Нашы Блог</h1>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-xxl-8 col-lg-7">
                            ...
                            <div class="th-blog blog-single has-post-thumbnail">
                                ...
                                <div class="blog-content">
                                    ...
                                    <h2 class="blog-title">
                                        <a href="blog-details.html">Influential Figures in the History of Gaming</a>
                                    </h2>
                            ...
                            <div class="th-blog blog-single">
                                <div class="blog-content">
                                    ...
                                    <h2 class="blog-title">
                                        <a href="blog-details.html">Must-Visit Gaming Events Worldwide</a>
                                    </h2>
                            ...
                            <div class="th-blog blog-single has-post-thumbnail">
                                ...
                                <div class="blog-content">
                                    ...
                                    <h2 class="blog-title">
                                        <a href="blog-details.html">Behind the Scenes of Your Favorite Titles</a>
                                    </h2>
                            ...
                            <div class="th-blog blog-single has-post-thumbnail">
                                ...
                                <div class="blog-content">
                                    ...
                                    <h2 class="blog-title">
                                        <a href="blog-details.html">Discover unparalleled expertise in market</a>
                                    </h2>
                                    ...
                                    <div class="recent-post-wrap">
                                        <div class="recent-post">
                                            ...
                                            <div class="media-body">
                                                <h4 class="post-title">
                                                    <a class="text-inherit" href="blog-details.html">A Day in the Life of an Esports Event</a>
                                                </h4>
                                        ...
                                        <div class="recent-post">
                                            ...
                                            <div class="media-body">
                                                <h4 class="post-title">
                                                    <a class="text-inherit" href="blog-details.html">Influential Figures in the History</a>
                                                </h4>
                                                <div class="recent-post-meta">
                                                    <a href="blog.html">
                                                        <i class="fa-light fa-calendar"></i>
                                        ...
                                        <div class="recent-post">
                                            ...
                                            <div class="media-body">
                                                <h4 class="post-title">
                                                    <a class="text-inherit" href="blog-details.html">Behind the Scenes of Your Favorite</a>
                                                </h4>
                                                <div class="recent-post-meta">
                                                    <a href="blog.html">
                                                        <i class="fa-light fa-calendar"></i>
