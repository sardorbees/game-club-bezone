                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-lg-12">
                            <div class="tournament-filter-btn2 filter-menu filter-menu-active">
                                <button data-filter="*" class="tab-btn th-btn style-border3 active" type="button">
                                    <span class="btn-border">
                                        ВСЕ МАТЧИ <i class="fa-solid fa-arrow-right ms-2"></i>
                                    </span>
                                </button>
                                <button data-filter=".cat1" class="tab-btn th-btn style-border3" type="button">
                                    <span class="btn-border">
                                        ПРЕДСТОЯЩИЙ МАТЧ <i class="fa-solid fa-arrow-right ms-2"></i>
                                    </span>
                                </button>
                                <button data-filter=".cat2" class="tab-btn th-btn style-border3" type="button">
                                    <span class="btn-border">
                                        ЗАВЕРШЕННЫЙ МАТЧ <i class="fa-solid fa-arrow-right ms-2"></i>
                                    </span>
                                </button>
                            </div>
                        </div>
                                ...
                                <div class="tournament-card-content">
                                    <div class="tournament-card-details" data-mask-src="assets/img/bg/tournament-card2-bg.png">
                                        ...
                                        <div class="card-title-wrap">
                                            <h6 class="tournament-card-subtitle">Pubg Mobile</h6>
                                            <h3 class="tournament-card-title">
                                                <a href="tournament-details.html">Lion King</a>
                                            </h3>
                                        </div>
                                    </div>
                                ...
                                <div class="tournament-card-content">
                                    <div class="tournament-card-details" data-mask-src="assets/img/bg/tournament-card2-bg.png">
                                        <div class="card-title-wrap text-md-end">
                                            <h6 class="tournament-card-subtitle">Pubg Mobile</h6>
                                            <h3 class="tournament-card-title">
                                                <a href="tournament-details.html">Team Gorilla</a>
                                            </h3>
                                        </div>
                                        <div class="tournament-card-date-wrap">
                                        ...
                                        <div class="card-title-wrap">
                                            <h6 class="tournament-card-subtitle">Pubg Mobile</h6>
                                            <h3 class="tournament-card-title">
                                                <a href="tournament-details.html">Badgamer</a>
                                            </h3>
                                        </div>
                                    </div>
                                    <div class="tournament-card-meta">
                                ...
                                <div class="tournament-card-content">
                                    <div class="tournament-card-details" data-mask-src="assets/img/bg/tournament-card2-bg.png">
                                        <div class="card-title-wrap text-md-end">
                                            <h6 class="tournament-card-subtitle">Pubg Mobile</h6>
                                            <h3 class="tournament-card-title">
                                                <a href="tournament-details.html">Ninja Rok</a>
                                            </h3>
                                        </div>
                                        <div class="tournament-card-date-wrap">
                                            <h2 class="tournament-card-time">07:30</h2>
                                ...
                                <div class="tournament-card-content">
                                    <div class="tournament-card-details" data-mask-src="assets/img/bg/tournament-card2-bg.png">
                                        ...
                                        <div class="card-title-wrap">
                                            <h6 class="tournament-card-subtitle">Pubg Mobile</h6>
                                            <h3 class="tournament-card-title">
                                                <a href="tournament-details.html">Casino Star</a>
                                            </h3>
                                        </div>
                                    </div>
                                    <div class="tournament-card-meta">
                                ...
                                <div class="tournament-card-content">
                                    <div class="tournament-card-details" data-mask-src="assets/img/bg/tournament-card2-bg.png">
                                        <div class="card-title-wrap text-md-end">
                                            <h6 class="tournament-card-subtitle">Pubg Mobile</h6>
                                            <h3 class="tournament-card-title">
                                                <a href="tournament-details.html">Cools Gaming</a>
                                            </h3>
                                        </div>
                                        <div class="tournament-card-date-wrap">
                                            <h2 class="tournament-card-time">06:30</h2>
                                        ...
                                        <div class="card-title-wrap">
                                            <h6 class="tournament-card-subtitle">Pubg Mobile</h6>
                                            <h3 class="tournament-card-title">
                                                <a href="tournament-details.html">Fire Dragon</a>
                                            </h3>
                                        </div>
                                    </div>
                                    <div class="tournament-card-meta">
                                ...
                                <div class="tournament-card-content">
                                    <div class="tournament-card-details" data-mask-src="assets/img/bg/tournament-card2-bg.png">
                                        <div class="card-title-wrap text-md-end">
                                            <h6 class="tournament-card-subtitle">Pubg Mobile</h6>
                                            <h3 class="tournament-card-title">
                                                <a href="tournament-details.html">Master Panda</a>
                                            </h3>
                                        </div>
                                        <div class="tournament-card-date-wrap">
                                        ...
                                        <div class="card-title-wrap">
                                            <h6 class="tournament-card-subtitle">Pubg Mobile</h6>
                                            <h3 class="tournament-card-title">
                                                <a href="tournament-details.html">Esports King</a>
                                            </h3>
                                        </div>
                                    </div>
                                    <div class="tournament-card-meta">
